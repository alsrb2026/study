...
import static org.techtown.ai_eng_v2_00.Ril_rank4.ril_r4_cnt;
...
public class Ril_rank3 extends Fragment {
    ...
    Button left;
    Button right;
    Ril_rank2 ril_rank2 = new Ril_rank2();
        ...
        if(num==0){
            ...
            left.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    transaction.replace(R.id.frame_layout, ril_rank2);
                    transaction.commit();
    ...
    public void ifcnt3(int ril_r3_cnt) { //3번이상 학습 시
        if (ril_r3_cnt == 3) {
            player.plusMP(70);
    ...
    public void ifcnt5(int ril_r3_cnt) { //5번이상 학습 시
        if (ril_r3_cnt == 5) {
