...
public class Voca1_2k extends Fragment {
    TextView apple;
    Button apple5;
    Button apple1;
    Button apple2;
    Button apple3;
    Button apple4;
    Voca1_3k voca1_3k = new Voca1_3k();

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup) getLayoutInflater().inflate(R.layout.voca1_2k, container, false);
        super.onCreate(savedInstanceState);
        View view = inflater.inflate(R.layout.voca1_2k,
                container,
                false);
        ...
        apple5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transaction.replace(R.id.container, voca1_3k);
                transaction.commit();
