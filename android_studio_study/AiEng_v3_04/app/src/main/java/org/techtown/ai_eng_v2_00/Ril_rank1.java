...
public class Ril_rank1 extends Fragment {
    ...
    public static int point1_clear_num = 0;
//    Point1_clear point1_clear = new Point1_clear();
        ...
        if(num==0){
            ...
            right.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    transaction.replace(R.id.frame_layout, point1_clear);
                    transaction.commit();*/
...
*/
    ...
    public void ifcnt3(int ril_r1_cnt) { //3번이상 학습 시
        if (ril_r1_cnt == 3) {
            player.plusMP(70);
    ...
    public void ifcnt5(int ril_r1_cnt) { //5번이상 학습 시
        if (ril_r1_cnt == 5) {
