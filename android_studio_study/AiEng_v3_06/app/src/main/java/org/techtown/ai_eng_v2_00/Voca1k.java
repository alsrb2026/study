...
public class Voca1k extends Fragment {
    TextView apple;
    Button apple5;
    Button apple1;
    Button apple2;
    Button apple3;
    Button apple4;
    Voca1_2k voca1_2k = new Voca1_2k();
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup) getLayoutInflater().inflate(R.layout.voca1k, container, false);
        super.onCreate(savedInstanceState);
        View view = inflater.inflate(R.layout.voca1k,
                container,
                false);
        ...
        apple5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transaction.replace(R.id.container, voca1_2k);
                transaction.commit();
        ...
        apple1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                wrongnum++;
                Intent intent = new Intent(getActivity(),Voca1_2k.class);
