...
public class Voca1_4 extends Fragment {
    TextView apple;
    Button apple5;
    Button apple1;
    Button apple2;
    Button apple3;
    Button apple4;
    Voca1_5 voca1_5 = new Voca1_5();

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup) getLayoutInflater().inflate(R.layout.voca1_4, container, false);
        super.onCreate(savedInstanceState);
        View view = inflater.inflate(R.layout.voca1_4,
                container,
                false);
        ...
        apple1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transaction.replace(R.id.container, voca1_5);
                transaction.commit();
