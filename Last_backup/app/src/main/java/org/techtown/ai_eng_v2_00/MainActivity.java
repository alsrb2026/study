...
RecyclerView recycler;
    ...
    @Override
        ...
        voca_practic = findViewById(R.id.voca_practice);
        voca_practic.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplication(),Voca_Practice.class);
                startActivity(intent);
            }
        });
